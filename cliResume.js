...
function displayList(){
       ...
       .then(function (answer) {
         if (answer.selection == "About") {
           ...
           cp.execSync('start chrome https://drive.google.com/file/d/1K4g2ukcL9EMKLx4FaPA8xZ303Z_kuqtG/view?usp=sharing')
           displayNext()
         } else if (answer.selection == "Projects") {
           cp.execSync('start chrome https://github.com/kavya1303 ')
           displayNext()
         }
       });
}
